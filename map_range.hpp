...
public:
    ...
    map_range( T value , F func , size_t max_iterations )
...
template< typename T , typename F >
auto make_map_range( T t , F f , size_t max_iterations )
{
    return map_range< T , F >( std::move( t ) , std::move( f ) , max_iterations );
}
